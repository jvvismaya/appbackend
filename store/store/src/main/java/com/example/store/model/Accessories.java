...
public class Accessories {
	...
	public Accessories(Long id, String typeofdevice, String manufacturer, String model, String os,
			String dateofpurchase, String currentclient, Long serielnumber, String location, String status) {
		super();
		this.id = id;
